    ...
    <section id="services" className="services-section">
      ...
      <div className="services-container">
        ...
        <div className="service-card">
          <img src="/images/brett-jordan-PFr50OBMowU-unsplash.jpg" alt="Structural Planning" className="service-image" />
        ...
        {/* Construction Card */}
        <div className="service-card">
          <img src="/images/tr-n-h-u-tung-_-V8Ar9fXWE-unsplash.jpg" alt="Construction" className="service-image" />
          <h3>Construction</h3>
        ...
        <div className="service-card">
          <img src="/images/jason-briscoe-AQl-J19ocWE-unsplash.jpg" alt="Interior Design" className="service-image" />
