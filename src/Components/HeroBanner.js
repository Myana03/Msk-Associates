...
export default function HeroBanner({ onStartProject }) {
  ...
  return (
    <div style={{ position: 'relative', height: '100svh', minHeight: '620px', overflow: 'hidden', backgroundColor: '#1c1c1c' }}>
            ...
            {shouldLoad && (
              <>
                ...
                <div style={{
                  ...
                  background: 'linear-gradient(110deg, rgba(28,28,28,0.86) 0%, rgba(28,28,28,0.58) 55%, rgba(28,28,28,0.18) 100%)',
                }} />
                <div style={{
                  position: 'absolute', inset: 0, zIndex: 1, pointerEvents: 'none',
                  background: 'linear-gradient(to top, rgba(28,28,28,0.82) 0%, rgba(28,28,28,0) 42%)',
                }} />
              </>
            )}
          </div>
      ...
      <div style={{
        ...
        >
          <span style={{ display: 'inline-block', width: '26px', height: '1.5px', backgroundColor: 'rgba(255,255,255,0.35)', flexShrink: 0 }} />
        ...
        <div style={{ overflow: 'hidden' }}>
          <motion.h1
            ...
            style={{
              ...
              letterSpacing: '-1.5px', color: '#ffffff', margin: 0,
            }}
          >
            Built by the people
          </motion.h1>
        ...
        <motion.div
          ...
          style={{ height: '2px', backgroundColor: 'rgba(255,255,255,0.35)', marginBottom: '1.6rem' }}
        />
        ...
        <motion.p
          ...
          style={{
            ...
            fontFamily: 'Figtree, sans-serif', lineHeight: 1.75,
      ...
      <div style={{
        ...
        <span style={{
          ...
          fontFamily: 'Figtree, sans-serif', letterSpacing: '0.2em',
          textTransform: 'uppercase',
        }}>Scroll</span>
      </div>
