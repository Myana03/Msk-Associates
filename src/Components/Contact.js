  ...
  return (
    <section id="contact" className="py-16 px-4 bg-gradient-to-b from-white to-blue-50">
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row gap-10 items-start">
        ...
        <div className="flex-1 w-full bg-white rounded-2xl shadow-lg p-8 flex flex-col justify-center">
          <h2 className="text-3xl font-extrabold text-blue-900 mb-6">Contact Us</h2>
