...
const NotFound = () => {
  return (
    <div className="fixed inset-0 bg-gray-950 flex flex-col items-center justify-center text-center px-6">
      <p className="text-orange-500 font-extrabold text-2xl tracking-widest mb-6">MSKASSOCIATES</p>
      ...
      <Link
        to="/"
        className="inline-block bg-orange-700 text-white font-bold py-3 px-8 rounded-lg hover:bg-orange-600 transition-colors"
      >
        Back to Home
      </Link>
    </div>
