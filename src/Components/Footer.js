...
const Footer = () => (
  <footer style={{ backgroundColor: '#20241F', borderTop: '3px solid #B33A2E' }}>
    <div className="max-w-7xl mx-auto px-6 lg:px-14" style={{ paddingTop: '4rem', paddingBottom: '3rem' }}>
      ...
      <div className="grid md:grid-cols-3 gap-12" style={{ paddingBottom: '3rem', borderBottom: '1px solid rgba(255,255,255,0.08)' }}>
          ...
          <div style={{ display: 'flex', gap: '1.2rem', marginTop: '1.5rem' }}>
            {[
              ...
              <a key={label} href={href} target={href.startsWith('http') ? '_blank' : undefined}
                ...
                onMouseEnter={e => e.currentTarget.style.color = '#B33A2E'}
        ...
        <div>
          <p style={{ fontSize: '0.58rem', color: '#B33A2E', fontWeight: 500, textTransform: 'uppercase', letterSpacing: '0.2em', fontFamily: 'Inter, sans-serif', marginBottom: '1.4rem' }}>Navigation</p>
        ...
        <div>
          <p style={{ fontSize: '0.58rem', color: '#B33A2E', fontWeight: 500, textTransform: 'uppercase', letterSpacing: '0.2em', fontFamily: 'Inter, sans-serif', marginBottom: '1.4rem' }}>Get in Touch</p>
